...
Depending on your package manager and package sources will effect your installation
...
Supports updates (package manager for a lot of open source software)
```shell script
...
Untested & unsupported - maybe it works in the linux subsystem (WSL).
...
<img loading="lazy" alt="Installing Docker Mate" width="1062" height="794.36" src={useBaseUrl('docs/undraw_setup_wizard.svg')} class="img--footer" />
