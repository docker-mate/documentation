...
author_url: https://github.com/orgs/docker-mate/people
...
<img loading="lazy" alt="History of Docker Mate" width="892.6139" height="540.80203" src={useBaseUrl('blog/undraw_season_change.svg')} class="img--footer img--blog" />
...
<img loading="lazy" alt="Release of Docker Mate" width="1144" height="652.52" src={useBaseUrl('blog/undraw_winners.svg')} class="img--footer img--blog" />

### Make your utility

We use Makefiles as wrapper for all commands. From `init` a project over creating a SQL backup, run commands like `console` inside a container to local command like `gulp watch` or simply checking `logs` & `state`.

### Tested in different OS environments

As described we the containers multiple years in different projects and also under different operating systems with Linux and macOS.We developed Symfony applications, Grav (file based CMS) or Shopware and extended different parts to the projects needs.

Windows is out of scope (bash, utilities ...) and no developer in our teams us it.

<img loading="lazy" alt="Docker Mate Open Source" width="1028" height="598.99741" src={useBaseUrl('blog/undraw_open_source.svg')} class="img--footer img--blog" />
...
<img loading="lazy" alt="Finial Public release Docker Mate" width="888" height="475.27072" src={useBaseUrl('blog/undraw_true_love.svg')} class="img--footer img--blog" />

### Questions?

Currently, we only have issues on GitHub. Ask something and will try to help.

:::info About the Blog
Don't expect a lot of entries, more activity should be on !
:::
