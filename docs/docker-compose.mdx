...
### Change build script
> Maybe install a additional package because your project needs it.
...
### Load something outside of the project
> Useful for shared resources or really large folders that causes trouble for the IDE
...
<img loading="lazy" alt="Docker Compose in Docker Mate" width="991.13988" height="770.17774" src={useBaseUrl('docs/undraw_professor.svg')} class="img--footer" />